...
//do not need to return anything, the above paints the page, 
//the coder does not need any information from renderFooter()
}
renderFooter()

//✅ 6. create a function called renderBook(book)

//these are consts because i don't intend on setting variable
//to new element, just changing things (textContent) within that element.
...
//.map would be used for updating each item in an array based on some logic
